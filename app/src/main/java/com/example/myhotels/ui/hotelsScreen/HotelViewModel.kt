...
import com.example.myhotels.domain.GetHotelListInteractor
...
class HotelViewModel(
    ...
    private val loadHotelsDataFromNetworkInteractor = LoadHotelsDataFromNetworkInteractor(repository)
